  ...
  return (
    <div className={className}>
      ...
      <textarea
        ref={ref}
        rows={rows}
        className={`block w-full rounded-lg border-0 py-3 px-4 shadow-sm ring-1 ring-inset transition-colors placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 resize-none ${
          theme === 'dark'
